...
<div class="bg-slate-800">
    ...
    <main>
        <div class="grid grid-cols-3 gap-2 place-content-center mt-16 ml-52 mr-52">
            <div class="p-5 text-white bg-slate-300/25 mr-5 rounded-md text-center place-content-center ">
   ...
   <!-- <div class="container mt-16 ml-52 mr-52 flex">   
        <div class="p-5 w-1/3 text-white bg-slate-300/25 mr-5 rounded-md text-center place-content-center">
            <h1 class="text-2xl font-heading mb-6">    
                Terras T'Hoekske
            </h1>
            <p>
